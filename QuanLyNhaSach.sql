...
insert into PHIEUNHAPSACH values('13/1/1990',N'Tấm Vải Đỏ',N'Kinh dị',N'Hồng Nương Tử',152)
insert into PHIEUNHAPSACH values('14/1/1990',N'The Haunting of Hill House',N'Kinh dị',N'Shirley Jackson',152)
insert into PHIEUNHAPSACH values('15/1/1990',N'Let the Right One In',N'Kinh dị',N'John Ajvide Lindqvist',152)
insert into PHIEUNHAPSACH values('16/1/1990',N'Tuổi thơ dữ dội',N'Văn học',N'Phùng Quán',152)
insert into PHIEUNHAPSACH values('17/1/1990',N'Giết con chim nhại',N'Văn học',N'Harper Lee',152)
insert into PHIEUNHAPSACH values('18/1/1990',N'Tiếng chim hót trong bụi mận gai',N'Văn học',N'Colleen McCullough, A. Ward',152)
insert into PHIEUNHAPSACH values('19/1/1990',N'Anh chàng Hobbits',N'Văn học',N'J. R. R. Tolkien',152)
insert into PHIEUNHAPSACH values('20/1/1990',N'Tôi thấy hoa vàng trên cỏ xanh',N'Tiểu thuyết',N'Nguyễn Nhật Ánh',150)
