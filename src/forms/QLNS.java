...
public class QLNS extends javax.swing.JFrame {
     ...
     */
    public static String sqlSach = "SELECT MAPN AS 'STT', TENSACH,THELOAI,TACGIA,SL FROM PHIEUNHAPSACH";
    ...
    public QLNS() {
        ...
        Cmb_Views.LoadData_MAPT(sqlcmb_ptt,Cmb_MAPT);//Ngu mai fix sau 
    ...
    private void initComponents() {
        ...
        jTextField7.setBounds(210, 20, 260, 26);

        jLabel54.setText("Nhập Mã Sách ");
        jPanel17.add(jLabel54);
        jLabel54.setBounds(310, 50, 150, 20);
        ...
        jToggleButton6.setBounds(480, 20, 97, 29);
        jPanel17.add(jSeparator6);
        jSeparator6.setBounds(0, 71, 785, 13);
        ...
        jScrollPane6.setBounds(10, 110, 750, 390);

        jLabel63.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel63.setText("Danh Sách Sách");
        jPanel17.add(jLabel63);
        jLabel63.setBounds(310, 80, 190, 20);
        ...
        jButton29.setBounds(340, 540, 63, 25);
        ...
        jTextField2.setBounds(210, 20, 260, 26);
        ...
        jToggleButton1.setBounds(480, 20, 97, 29);

        jLabel2.setText("Nhập Mã Phiếu Nhập Sách");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(260, 50, 210, 20);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(20, 80, 160, 20);

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel11.setText("Phiếu Nhập Sách");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(560, 80, 170, 22);
        ...
        jButton1.setBounds(340, 10, 93, 30);
        ...
        jButton2.setBounds(470, 10, 94, 30);
        ...
        jButton3.setBounds(600, 10, 93, 30);
        ...
        jPanel1.add(jPanel9);
        jPanel9.setBounds(10, 510, 770, 50);
        ...
        jTextField3.setBounds(210, 20, 260, 26);

        jLabel12.setText("Nhập Mã Hóa Đơn");
        jPanel2.add(jLabel12);
        jLabel12.setBounds(290, 50, 151, 20);
        ...
        jToggleButton2.setBounds(480, 20, 97, 29);
        ...
        jLabel20.setBounds(550, 80, 190, 20);
        ...
        jTextField4.setBounds(210, 20, 260, 26);
        jPanel5.add(jSeparator3);
        jSeparator3.setBounds(0, 71, 785, 13);

        jLabel23.setText("Nhập Mã Phiếu Thu Tiền");
        jPanel5.add(jLabel23);
        jLabel23.setBounds(280, 50, 150, 20);
        ...
        jToggleButton3.setBounds(480, 20, 97, 29);
        ...
        jLabel33.setBounds(550, 80, 190, 20);
        ...
        jTextField5.setBounds(210, 20, 260, 26);
        ...
        jToggleButton4.setBounds(480, 20, 97, 29);

        jLabel32.setText("Nhập Mã Báo Cáo Tồn");
        jPanel6.add(jLabel32);
        jLabel32.setBounds(280, 50, 210, 20);
        ...
        jLabel35.setBounds(550, 80, 190, 20);
        ...
        jTextField6.setBounds(210, 20, 260, 26);
        ...
        jToggleButton5.setBounds(480, 20, 97, 29);
        ...
        jLabel1.setBounds(280, 20, 240, 29);
...
//nut tim kiem phieu nhap
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
       if(this.jTextField2.getText().length() == 0) {
            String sql1 = "SELECT * FROM PHIEUNHAPSACH";
            UpdateTable.LoadData(sql1, jTable1);
        }
        else {
            String sql1 = "select * from PHIEUNHAPSACH where MAPN like N'%"+this.jTextField2.getText()+"%'";
//                    +"%'"+ "or DANHSACHSACH.TENSACH like N'%"+this.jTextField3.getText()+"%' or PHIEUTHUTIEN.HOTENKH N'%"+this.jTextField3.getText()+"%'";
            UpdateTable.LoadData(sql1, jTable1);
        }
...
//nut them phieu nhap
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       if(JOptionPane.showConfirmDialog(this, " Bạn có muốn thêm sách không?")== JOptionPane.NO_OPTION)
       {
        ...
        }else  JOptionPane.showMessageDialog(this,"Bạn chưa nhấn nút Thêm !");
...
//nut xoa phieu nhap
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(
            JOptionPane.showConfirmDialog(this, " Bạn có muốn xóa phiếu nhập sách nhập không?")==JOptionPane.NO_OPTION)
       {return;}     
       try{
...
//nut xoa hoa don
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(
            JOptionPane.showConfirmDialog(this, " Bạn có muốn xóa hóa đơn nhập không?")==JOptionPane.NO_OPTION)
       {return;}     
       try{
//            try(Connection ketNoi=CSDL.getKetNoi()){
//                ResultSet rs;
...
//nut xoa phieu thu
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(
            JOptionPane.showConfirmDialog(this, " Bạn có muốn xóa phiếu thu tiền không?")==JOptionPane.NO_OPTION)
        {return;}     
        try{
            try(Connection ketNoi=CSDL.getKetNoi()){
                ResultSet rs;
                ...
                rs=ps.executeQuery();
                if(rs.next()){
                    JOptionPane.showMessageDialog(this,"LỖI PHIẾU THU CÓ BÁO CÁO CÔNG NỢ, CẦN XÓA BÁO CÁO CÔNG NỢ CUA PHIẾU THU TƯƠNG ỨNG !");
                }
                else{
                    TXS3 txs3=new TXS3();
                    txs3.delete(Integer.parseInt(jTextField29.getText()));
                    JOptionPane.showMessageDialog(this, "Phiếu thu tiền đã được xóa khỏi CSDL");
                    this.jToggleButton3.doClick();
                }
            }
            catch (Exception e){
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
...
//nut xoa bao cao ton
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if(jTextField43.getText().equals("")){
            ...
            if(
            JOptionPane.showConfirmDialog(this, " Bạn có muốn xóa báo cáo tồn không?")==JOptionPane.NO_OPTION)
       {return;}     
       try{
//            try(Connection ketNoi=CSDL.getKetNoi()){
//                ResultSet rs;
...
//nut xoa bao cao cong no
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        ...
        if(jTextField42.getText().equals("")){
            ...
            if(
            JOptionPane.showConfirmDialog(this, " Bạn có muốn xóa phiếu báo cáo công nợ không?")== JOptionPane.NO_OPTION)
            {return;}     
            try{
                try(Connection ketNoi=CSDL.getKetNoi()){
                    ResultSet rs;
                    ...
                    rs=ps.executeQuery();
                    if(rs.next()){
                    JOptionPane.showMessageDialog(this,"LỖI ! HÓA ĐƠN BÁN SÁCH CÓ BÁO CÁO CÔNG NỢ CẦN XÓA BÁO CÁO CÔNG NỢ TƯƠNG ỨNG !");
                }
                else{
                         TXS5 txs5=new TXS5();
...
//nut tim kiem hoa don
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        if(this.jTextField3.getText().length() == 0) {
            String sql1 = "SELECT d.MAHD,e.HOTENKH,d.NGAYLAPHOADON,p.TENSACH,p.THELOAI,d.SL,d.DONGIA FROM PHIEUNHAPSACH p, HOADONBANSACH d, PHIEUTHUTIEN e where p.MAPN = d.MAPN and d.MAPT = e.MAPT";
...
//nut tim kiem phieu thu
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        ...
        if(this.jTextField4.getText().length() == 0) {
            String sql1 = "select * from PHIEUTHUTIEN";
            UpdateTable.LoadData(sql1, jTable3);
        }
        else {
            String sql1 = "select * from PHIEUTHUTIEN where MAPT like N'%"+this.jTextField4.getText()+"%'";
//                    +"%'"+ "or DANHSACHSACH.TENSACH like N'%"+this.jTextField3.getText()+"%' or PHIEUTHUTIEN.HOTENKH N'%"+this.jTextField3.getText()+"%'";
            UpdateTable.LoadData(sql1, jTable3);
        }
...
//nut tim kiem bao cao ton
    private void jToggleButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton4ActionPerformed
        ...
        if(this.jTextField5.getText().length() == 0) {
            String sql1 = "select a.MABCT,a.THANG,b.TENSACH, a.TONDAU,a.PHATSINH, (a.TONDAU+a.PHATSINH) AS 'TONCUOI' from BAOCAOTON a ,PHIEUNHAPSACH b where a.MAPN =b.MAPN";
            UpdateTable.LoadData(sql1, jTable4);
        }
        else {
...
//                    +"%'"+ "or DANHSACHSACH.TENSACH like N'%"+this.jTextField3.getText()+"%' or PHIEUTHUTIEN.HOTENKH N'%"+this.jTextField3.getText()+"%'";
    ...
    private void jToggleButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton6ActionPerformed
        // TODO add your handling code here:
        String sql1 = "select * from PHIEUNHAPSACH where MAPN like N'%"+this.jTextField7.getText()+"%'";
        UpdateTable.LoadData(sql1, jTable6);
...
//nut tim kiem bao cao cong no
    private void jToggleButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton5ActionPerformed
        ...
        if(this.jTextField6.getText().length() == 0) {
            String sql1 = "select b.MABCCN, b.THANG, t.HOTENKH,b.NODAU,b.PHATSINH, (NODAU+PHATSINH) as'NOCUOI' from BAOCAOCONGNO b , PHIEUTHUTIEN t where b.MAPT = t.MAPT";
            UpdateTable.LoadData(sql1, jTable5);
        }
        else {
